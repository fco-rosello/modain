      ...
      <div id="mostrar_marca" class="col-lg col-sm col-md">
        ...
        <div class="card ">
            <div class="card-header d-flex">
              <span>Marcas</span>
              <a class="btn btn-primary ml-auto" href="{{ route('marca.create') }}">Crear marca</a>
            </div>
            <div class="card-body">
              <div class="container-fluid table-responsive">
              <table id="Marcas" class="table table-bordered table-hover table-striped dt-responsive display nowrap" cellspacing="0"
                width="100%">
