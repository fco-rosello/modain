      ...
      @include('Common.error')
        <div class="card ">
            <div class="card-header d-flex">
              <span>Ciudades</span>
              <a class="btn btn-primary ml-auto" href="{{ route('ciudad.create') }}">Crear ciudad</a>
            </div>
            <div class="card-body">
              <div class="container-fluid table-responsive">
              <table id="Ciudades" class="table table-bordered table-hover table-striped dt-responsive display nowrap" cellspacing="0"
                width="100%">
      ...
      $(document).ready(function(){
          $('#Ciudades').DataTable({
            ...
            "language":{
             ...
             "columns":[
               {data: 'cod_ciudad', name: 'cod_ciudad'},
